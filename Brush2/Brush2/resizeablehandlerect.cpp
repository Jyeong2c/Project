...
ResizeableHandleRect::ResizeableHandleRect()
{
...
void ResizeableHandleRect::drawHandles()
{
...
void ResizeableHandleRect::setOwnerItem(QGraphicsItem *value)
{
    ownerItem = value;
}

void ResizeableHandleRect::drawHandlesIfNecessary()
{
//    if(!ownerItem){
