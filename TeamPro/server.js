...
var p1Images = [
    {ID : '1001', ImageName : 'P1_14FMX0-1', PixelLength : 0.005, ImageKinds : 'IO', ImagePathURL : 'http://' + hostName + ':' + portNum + '/Files/P1_14FMX0-1.png'},
    {ID : '1002', ImageName : 'P1_14FMX0-2', PixelLength : 0.005, ImageKinds : 'IO', ImagePathURL : 'http://' + hostName + ':' + portNum + '/Files/P1_14FMX0-2.png'},
    {ID : '1003', ImageName : 'P1_14FMX0-3', PixelLength : 0.005, ImageKinds : 'IO', ImagePathURL : 'http://' + hostName + ':' + portNum + '/Files/P1_14FMX0-3.png'},
    {ID : '1004', ImageName : 'P1_14FMX0-4', PixelLength : 0.005, ImageKinds : 'IO', ImagePathURL : 'http://' + hostName + ':' + portNum + '/Files/P1_14FMX0-4.png'},
    {ID : '1005', ImageName : 'P1_14FMX0-5', PixelLength : 0.005, ImageKinds : 'IO', ImagePathURL : 'http://' + hostName + ':' + portNum + '/Files/P1_14FMX0-5.png'},
    {ID : '1006', ImageName : 'P1_14FMX0-6', PixelLength : 0.005, ImageKinds : 'IO', ImagePathURL : 'http://' + hostName + ':' + portNum + '/Files/P1_14FMX0-6.png'},
    {ID : '1007', ImageName : 'P1_14FMX0-7', PixelLength : 0.005, ImageKinds : 'IO', ImagePathURL : 'http://' + hostName + ':' + portNum + '/Files/P1_14FMX0-7.png'},
    {ID : '1008', ImageName : 'P1_14FMX0-8', PixelLength : 0.005, ImageKinds : 'IO', ImagePathURL : 'http://' + hostName + ':' + portNum + '/Files/P1_14FMX0-8.png'},
    {ID : '1009', ImageName : 'P1_14FMX0-9', PixelLength : 0.005, ImageKinds : 'IO', ImagePathURL : 'http://' + hostName + ':' + portNum + '/Files/P1_14FMX0-9.png'},
    {ID : '1010', ImageName : 'P1_14FMX1-0', PixelLength : 0.005, ImageKinds : 'IO', ImagePathURL : 'http://' + hostName + ':' + portNum + '/Files/P1_14FMX1-0.png'},
    {ID : '1011', ImageName : 'P1_14FMX1-1', PixelLength : 0.005, ImageKinds : 'IO', ImagePathURL : 'http://' + hostName + ':' + portNum + '/Files/P1_14FMX1-1.png'},
    {ID : '1012', ImageName : 'P1_14FMX1-2', PixelLength : 0.005, ImageKinds : 'IO', ImagePathURL : 'http://' + hostName + ':' + portNum + '/Files/P1_14FMX1-2.png'},
    {ID : '1013', ImageName : 'P1_14FMX1-3', PixelLength : 0.005, ImageKinds : 'IO', ImagePathURL : 'http://' + hostName + ':' + portNum + '/Files/P1_14FMX1-3.png'},
    {ID : '1014', ImageName : 'P1_14FMX1-4', PixelLength : 0.005, ImageKinds : 'IO', ImagePathURL : 'http://' + hostName + ':' + portNum + '/Files/P1_14FMX1-4.png'},
    {ID : '1015', ImageName : 'panorama1', PixelLength : 0.005, ImageKinds : 'panorama', ImagePathURL : 'http://' + hostName + ':' + portNum + '/Files/panorama1.png'}
]
