...
private:
   ...
   QNetworkAccessManager *patientManager; //네트워크를 통해 요청/응답을 시행하는 메니저 변수(환자 정보 URL접근 mananger)
...
private:
    /*서버로부터 이미지 파일을 받을 변수들을 설정*/
    QNetworkAccessManager *imageManager; //네트워크를 통해 요청을 보낼수 있는 메니저 변수(환자의 이미지 정보 URL접근 mananger)
